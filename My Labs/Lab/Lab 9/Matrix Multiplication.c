// Topic - Implement a multi-threaded program that is doing the matrix multiplication using multiple threads.

// Run using "gcc -pthread Matrix Multiplication.c && Then ./a.out"
