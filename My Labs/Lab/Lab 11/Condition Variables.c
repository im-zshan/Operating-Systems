// Topic - To Implement the condition variables and semaphores using Pthread library.

// Run Using "gcc -pthread 20_producer_consumer_multi_condition_variables.c && Then ./a.out"
